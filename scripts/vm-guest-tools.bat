...
if "%PACKER_BUILDER_TYPE%" equ "vmware-windows-iso" goto :vmware
if "%PACKER_BUILDER_TYPE%" equ "virtualbox-windows-iso" goto :virtualbox
goto :done
...
if not exist "C:\Windows\Temp\windows.iso" (
    powershell -Command "(New-Object System.Net.WebClient).DownloadFile('http://softwareupdate.vmware.com/cds/vmw-desktop/ws/8.0.6/1035888/windows/packages/tools-windows-8.8.6.exe.tar', 'C:\Windows\Temp\vmware-tools.exe.tar')" <NUL
